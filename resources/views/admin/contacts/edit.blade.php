...
<head>
    ...
    .container {
        background-color: #3a2c56; /* Soft Purple Background */
        border-radius: 12px;
    ...
    h1 {
        ...
        margin-bottom: 30px;
        text-align: center;
        text-shadow: 0 0 10px rgba(156, 39, 176, 0.8); /* Soft Purple Glow */
    }
    ...
    .form-control:focus {
        ...
        box-shadow: 0 0 0 0.2rem rgba(156, 39, 176, 0.5); /* Soft Purple Glow */
    }
