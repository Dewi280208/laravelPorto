...
<head>
    ...
    .back-arrow-btn {
        padding: 10px;
        background-color: #8e44ad; /* Soft purple */
        color: #fff;
    ...
    .back-arrow-btn:hover {
        background-color: #7d3c8e;
        box-shadow: 0 0 20px #7d3c8e, 0 0 30px #7d3c8e;
    ...
    .container {
        ...
        gap: 20px;
        margin: 20px;
        padding-top: 60px; /* Menambahkan ruang untuk tombol panah */
    }
    ...
    .content h2 {
        font-size: 28px;
        color: #9b59b6; /* Soft purple for the title */
        margin-bottom: 10px;
    }
    ...
    .sidebar h3 {
        font-size: 20px;
        color: #9b59b6; /* Soft purple for the sidebar title */
        margin-bottom: 15px;
    }
    ...
    .sidebar ul li a:hover {
        color: #8e44ad; /* Lighter soft purple when hover */
