...
<head>
    ...
    * {
    ...
    /* Header Section */
    .header {
        background: linear-gradient(135deg, #9b59b6, #8e44ad); /* Soft purple gradient */
        color: white;
        padding: 100px 20px;
        text-align: center;
        border-bottom: 4px solid #9b59b6; /* Soft purple border */
        box-shadow: 0px 10px 50px rgba(155, 89, 182, 0.3); /* Soft purple shadow */
        margin-bottom: 50px;
    }
    ...
    .header h1 {
        ...
        margin-bottom: 20px;
        text-shadow: 0px 0px 15px rgba(155, 89, 182, 0.7); /* Soft purple text-shadow */
    }
    ...
    .skill-card h2 {
        font-size: 2rem;
        color: #9b59b6; /* Soft purple for skill card title */
        margin-bottom: 20px;
        font-weight: 600;
    ...
    .fab {
        ...
        bottom: 30px;
        right: 30px;
        background-color: #9b59b6; /* Soft purple FAB */
        padding: 15px;
        border-radius: 50%;
        font-size: 1.8rem;
        color: white;
        text-align: center;
        box-shadow: 0px 5px 30px rgba(155, 89, 182, 0.3);
        transition: all 0.3s ease;
    }
    ...
    .btn-edit {
        background-color: #9b59b6; /* Soft purple for edit button */
        color: white;
