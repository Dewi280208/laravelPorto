...
.container {
    ...
    padding-left: 40px; /* Shift container content to the right */
}
...
.form-label {
    ...
    color: #9b59b6; /* Soft purple color for labels */
}
...
.btn-success {
    ...
    width: 90%; /* Slightly smaller width for button */
    margin-left: 5%; /* Shift button to the right */
...
@media (max-width: 600px) {
    .container {
        ...
        padding-left: 10px; /* Slight shift right on small screens */
    }
